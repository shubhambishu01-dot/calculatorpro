...
class _SalesTaxScreenState extends State<SalesTaxScreen> {
  ...
  double get taxAmount => price * rate / 100;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Sales Tax', style: TextStyle(color: textColor)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _field('Price (before tax)', priceController, textColor, cardColor),
            const SizedBox(height: 16),
            _field('Tax rate (%)', rateController, textColor, cardColor,
                suffix: '%'),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _row('Tax amount', taxAmount, textColor, widget.accentColor),
                  const SizedBox(height: 10),
                  _row('Total price', totalPrice, textColor, textColor,
                      big: true),
                ],
              ),
            ),
